...
<ul class="breadcrumb">
  <li><a href="${home}"><app.spring:message code="label.home"/></a> <span class="divider">/</span></li>
  <li><app.spring:message code="label.ninja"/></li>
</ul>
		...
		<div id="search-panel-inner" data-spy="affix" data-offset-top="60">
			<div class="navbar">
				<div class="navbar-inner">
					<span class="brand"><i class="icon-search"></i><app.spring:message code="label.search" /></span>
			...
			<div class="search-form collapse">
				<form:form modelAttribute="searchCommand" id="ninja-search" >
					...
					<hr/>
					<input type="submit" class="btn btn-info btn-block" data-submit="search" value="<app.spring:message code="label.search"/>">
					<button type="button" class="btn btn-link btn-block" data-submit="clear"><app.spring:message code="label.clear" /></button>
				</form:form>
			</div>
		</div>
	</div>
	...
	<div id="results-panel" class="span9">
		...
		<div id="message-panel" class="row-fluid">
			<button id="ninja-add" class="btn btn-info add-action">
				...
				<app.spring:message code="label.ninja.add" />
			</button>
			<div class="status" data-display-pagelinks="false" data-display-summary="true" data-summary-message='
				<app.spring:message code="message.displaying-x-of-y" arguments="#start,#end,#total,records"/>
			'>
				...
				<table id="ninja-results" class="footable table-bordered table-striped table-hover table-condensed" data-page="${results.currPage}" >
					<thead>
						<tr class="table-header">
							<th data-class="expand" data-field-name="completeName"><app.spring:message code="label.ninja.completeName"/></th>
							<th data-class="expand" data-field-name="completeName"><app.spring:message code="label.ninja.photo"/></th>
		                   	<th data-hide="phone" data-field-name="email"><app.spring:message code="label.ninja.email"/></th>
		                	<th data-hide="phone,tablet" data-field-name="age"><app.spring:message code="label.ninja.age"/></th>
		               		<th data-hide="phone,tablet" data-field-name="score"><app.spring:message code="label.ninja.score"/></th>
		               		<th data-hide="phone,tablet" data-field-name="joinDate"><app.spring:message code="label.ninja.joinDate"/></th>
		               		<th data-hide="phone,tablet" data-field-name="active"><app.spring:message code="label.ninja.active"/></th>
					...
					<tbody>
						<script type="text/template" class="template">
	                		<tr id="ninja-row-{{id}}" data-id="{{id}}">
								...
								<td>
									<div class="btn-group">
									  ...
									  <ul class="dropdown-menu">
									    <li><a data-url="${home}/ninja/photo/upload?id={{id}}" class="upload-photo"><i class="icon-upload"></i> <app.spring:message code="photo.change-photo" /></a></li>
									    <li><a data-url="${home}/ninja/photo/adjust?id={{id}}" class="adjust-photo"><i class="icon-edit"></i> <app.spring:message code="photo.edit-thumbnail" /></a></li>
									  </ul>
									</div>
								</td>
	                			<td>{{email}}</td>
								...
								<td>{{active}}</td>
								<td>
									<i class='icon-pencil edit-action' data-id='{{id}}' data-title="<app.spring:message code="label.edit" />"></i>
									<i class='icon-trash remove-action' data-id='{{id}}' data-title="<app.spring:message code="label.delete" />"></i>
								</td>
							</tr>
						</script>
							...
							<tr id="ninja-row-${record.id}" data-id="${record.id}">
								...
								<td>
									<div class="btn-group">
									  ...
									  <ul class="dropdown-menu">
									    <li><a data-url="${home}/ninja/photo/upload?id=${record.id}" class="upload-photo"><i class="icon-upload"></i> <app.spring:message code="photo.change-photo" /></a></li>
									    <li><a data-url="${home}/ninja/photo/adjust?id=${record.id}" class="adjust-photo"><i class="icon-edit"></i> <app.spring:message code="photo.edit-thumbnail" /></a></li>
									  </ul>
									</div>
								</td>
								...
								<td>
									<i class='icon-pencil edit-action' data-id='${record.id}' data-title="<app.spring:message code="label.edit" />"></i>
									<i class='icon-trash remove-action' data-id='${record.id}' data-title="<app.spring:message code="label.delete" />"></i>
								</td>
							</tr>
						</c:forEach>
					</tbody>
...
<div id="form-body" class="modal fade hide">
	...
	<div id="form-panel" >
		<div class="modal-header">
			...
			<h4 class="${add}"><app.spring:message code="label.ninja.add" /></h4>
			<h4 class="${update}"><app.spring:message code="label.ninja.update" /></h4>
		</div>
		...
		<form:form modelAttribute="formCommand" id="ninja-form" cssClass="form-horizontal">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-link" data-dismiss="modal"><app.spring:message code="label.close" /></button>
				<input type="submit" class="btn btn-info  ${add}" data-form-display="add" data-submit="save-and-new" value="<app.spring:message code="label.save-and-new" />" />
				<input type="submit" class="btn btn-success" data-submit="save" value="<app.spring:message code="label.save" />" />
