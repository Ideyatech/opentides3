...
<form:form id="upload-file" commandName="command" enctype="multipart/form-data"
		method="POST" action="${home}/file/upload/">
	...
	<div class="modal-body">
		...
		<div class="span5">
			<input type="file" id=file name="attachment" style="visibility: hidden;" accept="image/*"/>
