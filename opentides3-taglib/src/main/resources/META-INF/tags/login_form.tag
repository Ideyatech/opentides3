...
<%@ attribute name="supportRememberMe" required="false" type="java.lang.String"%>
	...
	<div class="control-group">
		<div class="input-prepend">
			<span class="add-on"><i class="icon-user"></i></span> <input
				class="input-large" type="text" name="j_username" 
	...
	<div class="control-group">
		<div class="input-prepend">
			<span class="add-on"><i class="icon-lock"></i></span> <input
				class="input-large" type="password" name="j_password" placeholder="Password">
		</div>
	</div>

<c:if test="${supportRememberMe eq 'true'}">
	<div class="control-group">
