...
public class ViewInjectingReturnValueHandler implements
	...
	public void handleReturnValue(Object returnValue,
		...
		Class<? extends Views.BaseView> viewClass = getDeclaredViewClass(returnType);
		if (viewClass != null) {
	 ...
	 * @return
	 */
	private Class<? extends Views.BaseView> getDeclaredViewClass(
	...
	private Object wrapResult(Object result,
			Class<? extends Views.BaseView> viewClass) {
