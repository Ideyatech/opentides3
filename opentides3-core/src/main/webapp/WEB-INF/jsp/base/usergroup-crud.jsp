...
<app:header pageTitle="label.usergroup">
    ...
    <!--Content-->
	<div id="usergroup-body" class="container container-fluid">
   		...
   		<div id="form-body" class="page ${form}">
	   		<div id="form-panel">
			  	<div class="modal-header">
			   	 	<h3 class="${add}"><spring:message code="label.usergroup.add" /></h3>		    
			   	 	<h3 class="${update}"><spring:message code="label.usergroup.update" /></h3>			    
			  	</div>
