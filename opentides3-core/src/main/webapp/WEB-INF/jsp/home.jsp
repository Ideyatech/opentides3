...
<app:header pageTitle="label.home" active="home"/>
	...
	<h1><i class="icon-coffee"></i> Welcome to Opentides 3</h1>
	...
	<div class="row-fluid">
		<div class="span4">
			<h2><i class="icon-fighter-jet"></i> Super Fast</h2>
		...
		<div class="span4">
			<h2><i class="icon-desktop"></i> Responsive</h2>
		...
		<div class="span4">
			...
			<p>In this same New Bedford there stands a Whaleman's Chapel, and few are the moody fishermen, shortly bound for the Indian Ocean or Pacific, who fail to make a Sunday visit to the spot. I am sure that I did not.</p>
