...
<div class="row-fluid">
	...
	<div class="span10">
		...
		<section id="archetype">
			<h3>Installing the maven archetype for Opentides 3</h3>
			<p>
		...
		<section id="server">
			<h3>Adding the project on a Tomcat server</h3>
		...
		<p>
			...
			<br/><br/>
			<img src="img/tides-login.png" width="800px" class="img-polaroid"/>
			<br/><br/>
